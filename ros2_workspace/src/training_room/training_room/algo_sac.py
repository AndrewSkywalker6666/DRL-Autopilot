...
# RL training
ALG_NAME = 'SAC'
TRAIN_EPISODES = 30  # total number of episodes for training
...
class SAC:
    ...
    def save(self):  # save trained weights
        path = os.path.join('/home/chh3213/PycharmProjects/test/gym_APM/gym_apm/algos/model', '_'.join([ALG_NAME, ENV_ID]))
